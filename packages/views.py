...
def home(request):
  if request.method=="POST":
    ...
    return render(request,"pages-blank.html",{'daylist':daylist,'destinationlist':destinationlist})
...
def packageview(request):
  ...
  if 'itinerary' in request.POST:
    ...
    for key in mainpackagedict:
      ...
      print("\n")
    print("*********temppackagedict******")    
    return render(request,'tour-packages.html',{'mainpackagedict':mainpackagedict,'day':day,'district':destination,'temppackagedict':temppackagedict},)
...
def landscapeview(request):
   ...
   return render(request,'landscape-packages.html',{'mainpackagedictcopy':mainpackagedictcopy,'day':day,'district':destination,'landscapelist':landscapelist,'temppackagedictcopy':temppackagedictcopy},)
...
def landscapefilter(request,mainpackagedictcopy,temppackagedictcopy,day):
              ...
              if key not in mainpackagedictcopy:
                    for innerdictitems in dictitems:
                      if item in innerdictitems:
                          ...
                          for innerdictitems in dictitems:
                             temppackagedictcopy[key]=innerdictitems
                             break
        print('\nmainpackagedict->',mainpackagedict)
        print('\nmainpackagedictcopy->',mainpackagedictcopy)
    ...
    return render(request,'landscape-packages.html',{'mainpackagedictcopy':mainpackagedictcopy,'day':day,'district':destination,'landscapelist':landscapelist,},)
